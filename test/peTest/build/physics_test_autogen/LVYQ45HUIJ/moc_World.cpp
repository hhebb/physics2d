...
QT_MOC_LITERAL(1, 6, 13), // "physicsUpdate"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "World\0physicsUpdate\0"
};
...
void World::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->physicsUpdate((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (World::*)(QVariant );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&World::physicsUpdate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void World::physicsUpdate(QVariant _t1)
{
