...
void TriangleWindow::initialize() {
	...
	if (!m_program->addShaderFromSourceFile(QOpenGLShader::Vertex, "/home/hebb/project/rlstudio/src/shaders/pass_through.vert"))
		qDebug() << "Vertex shader errors:\n" << m_program->log();

	if (!m_program->addShaderFromSourceFile(QOpenGLShader::Fragment, "/home/hebb/project/rlstudio/src/shaders/simple.frag"))
